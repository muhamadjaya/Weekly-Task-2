  ...
  return (
    <>
      <div className="container">
        <h2 className="head-title">3 Introduction UI/UX</h2>
        <h3 className="pt-3">Resume</h3>
        <p>Dalam materi ini, mempelajari:</p>
        <ol>
          <li className="list-content">User Experience (UX)</li>
          ...
          <li className="list-content">User Interface (UI)</li>
          <div className="paragraph-content">
          ...
          <li className="list-content">Prototyping</li>
          <div className="paragraph-content">
        ...
        <ol>
          <li className="list-content">Mengidentifikasi desain website</li>
          <div className="paragraph-content">
        ...
        <a
          href="https://docs.google.com/document/d/195kR_m6vdOyUv4josiMmulSV7knx1VHaWX1utf5VQok/edit"
          className="link-task"
        >
          Introduction UI/UX
        </a>
